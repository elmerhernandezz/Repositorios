...
<main>
    <?php foreach($productos as $row) {?>
        <div class="info_producto">
            <?php if($row['id_Producto'] == $_GET['idP']) {?>
                <?php
                    $id = $row['id_Producto'];
                    $imagen = "./imagenes/productos/" . $id . "/main.webp";
                    $imagen1 = "./imagenes/productos/" . $id . "/main1.webp";
                    $imagen2 = "./imagenes/productos/" . $id . "/main2.webp";

                    if(!file_exists($imagen)){
                        $imagen = "./imagenes/error.png";
                    }
                    if(!file_exists($imagen1)){
                        $imagen1 = "./imagenes/error.png";
                    }
                    if(!file_exists($imagen2)){
                        $imagen2 = "./imagenes/error.png";
                    }
                    $cat = $row['id_Categoria'];
                    $idN = $id;
                ?>
                <ul class="product" name="idC">
                    <li><img src="<?php echo $imagen; ?>" alt=""></li>
                    <li><img src="<?php echo $imagen1; ?>" alt=""></li>
                    <li><img src="<?php echo $imagen2; ?>" alt=""></li>
                </ul>
                <picture class="img-producto">
                    <img src="<?php echo $imagen; ?>" alt="">
                </picture>
                <div class="datosproduct">
                    <h3><?php echo $row['Nombre_Producto']; ?></h3>
                    <h1>PRECIO: $<?php echo $row['Precio']; ?></h1>
                    <div class="wrapper">
                        <i class="fa-solid fa-circle-minus minus" style="color: #0292C4;"></i>
                        <span class="num">01</span>
                        <i class="fa-solid fa-circle-plus plus" style="color: #FFB200;"></i>
                    </div>
                    <div class="agregarC">
    ...
    <div class="Carousell Carousel-P">
        <div class="slick-list listaP backgroundP" id="slick-list">
            ...
            <div class="tituloSugeridos">
                <h2>PRODUCTOS SUGERIDOS</h2>
            </div>
            <div class="slick-track" id="track">
                <?php foreach($productos as $row) { ?>
                    <?php if($row['id_Producto'] != $idN) { ?>
                        <?php if($row['id_Categoria'] == $cat) { ?> 
